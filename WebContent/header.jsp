    ...
    <div class="container-fluid text-center"
        ...
        <form class="form-inline" action="index.jsp" method="get">
            <div class="input-group">
                <input type="text" class="form-control" size="50" name="search" id="search"
            ...
            <button class="btn btn-primary" onclick="startDictation()">Speak</button>
        </form>
        <p align="center"
    ...
    if (SpeechRecognition) {
        ...
        recognition.onresult = function (event) {
            ...
            if (searchField) {
                ...
                var cleanedSpeech = transcript.replace(/[.,\/#!$%\^&\*;:{}=\-_`~()]/g, "");
                // Trim leading and trailing spaces
                cleanedSpeech = cleanedSpeech.trim();
                // Populate the cleaned speech into the search input field
                searchField.value = cleanedSpeech;
            }
        };
